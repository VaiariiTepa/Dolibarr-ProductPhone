...
print '<div class="container">';
	print '<div id="bandeau">';
		print '<img width="100%" class="enhaut"src="img\bandeau_tatoo.png">';
	print '</div>';
print '</div>';
...
print '<div class="container-fluid">';
	...
	print '<div id="body_caracteristique">';		
		print '<div class="separation">';
			print '<center>';
				print '<img width="100%" src="img\separation.png">';
			print '</center>';
		print '</div>';
		print '<br>';
		print '<div id="caracteristique">';
			foreach ($t_capacity_promotion as $value) {
				print '<table>';
					print '<tr>';
						print '<th width="33.33%">';
							print '<img src="img\phone_size.png">';
						print '</th>';
						print '<th width="33.33%">';
						...
						print '</th>';
						print '<th width="33.33%">';
							print '<img src="img\camera_resolution.png">';
						print '</th>';
					print '</tr>';
					print '<tr>';
				...
				print '<table>';
					print '<tr>';
						print '<th width="33.33%">';
							print '<img src="img\Processeur.png">';
						print '</th>';
						print '<th width="33.33%">';
							print '<img src="img\Dual-sim.png">';
						print '</th>';
						print '<th width="33.33%">';
							print '<img width="100" src="img\batterie.png">';
						print '</th>';
					print '</tr>';
					print '<tr>';
						print '<td width="33.33%">';
			...
			print '<div class="separation">';
				print '<center>';
					print '<img width="100%" src="img\separation_bas.png">';
				print '</center>';
			print '</div>';
		print '</div>';
		print '<br>';
			...
			print '<table width="100%" id="table_color">';
				print '<tr>';
					...
					if ($value['os_name'] == 'Android') {
						print '<img width="35" src="img\android.png">';
						print '<b>';
						print '</b>';
						print $value['os_version'];
					}elseif($value['os_name'] == 'iOS'){
						print '<img width="35" src="img\apple.png">';
						print '<b>';
							print $value['os_version'];
						print '</b>';
					}else{
					...
					print '<td width="25%">';
						print '<div>';
							print '<img width="35" src="img\memoire.jpg">';
							print '<b>';
	...
	print '<div class="container-fluid">';
		print '<div id="logo_footer">';
			print '<img width="400" src="img\logo_footer_right.png">';
		print '</div>';
	print '</diV>';
