...
class ProductPhone //extends CommonObject
{
    ...
    function __construct($db)
  {
    ...
    /**
     * Insert des données dans productPhoneRaw
     */
...
//        echo $sql;
        ...
        /* ================================================================= */
        /* ================================================================= */
//var_dump($t_search_productphone);
...
//        echo $sql;
     ...
     * @return array
     */
    function gen_value_filter($pre_filter_value){

        $filter_value = substr($pre_filter_value,18);
